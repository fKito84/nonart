...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <!-- Dades del material crític de la Base de Dades -->
            <ul>
                <li>
                    <strong>Material:</strong> 
                    {{ $material->nom_material ?? 'Material desconegut' }}
                </li>
                <li>
                    <span class="alert">
                        <strong>Quantitat restant:</strong> 
                        {{ $material->quantitat }} unitats
                    </span>
                </li>
            </ul>
            
            <p>Si us plau, revisa l'inventari i fes una comanda aviat per evitar quedar-te sense 
               subministraments per als propers tallers.</p>
        </div>
